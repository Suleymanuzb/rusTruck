    ...
    return (
        <div>
            <div className='relative text-end hidden lg:block'>
                ...
                {isOpen && (
                    <div className='absolute z-60 text-[14px] p-3 left-26.25 bg-[rgb(255,255,255)] rounded-lg top-[top: 18px] shadow-xl'>
                        <p className='text-start mb-3 whitespace-nowrap'>
