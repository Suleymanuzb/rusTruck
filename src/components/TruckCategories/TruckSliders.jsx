...
const TruckSliders = forwardRef(({ currentLang }, ref) => {
    return (
        <>
            ...
            >
                {currentLang.header.megaMenu.categories.types.map((truck) => {
                    ...
                    return (
                        <SwiperSlide key={truck.id}>
                            ...
                            >
                                <div>
                                    <span
                                        className={`block text-[18px] min-[1200px]:text-2xl leading-[1.2] ${truck.name.includes(" ") ? "line-clamp-2" : "truncate"}`}
                                    >
                                        {truck.name}
                                    </span>
                                    <div>
