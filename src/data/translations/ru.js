...
<div class="text-[18px] leading-[1.5]">
    <div class="[&>h2]:text-[22px] [&>h2]:mt-[20px] [&>h2]:mb-[3.125rem]">
        <p class="mb-4">Надёжное снабжение топливом упрощает работу на любых объектах. Купить автотопливозаправщик — возможность заправлять технику прямо на месте, экономя время и снижая расходы. Оборудование оснащено прочными цистернами и современными насосами для точного учета топлива. Компания «РусТрак» предлагает модели, которые подходят для различных задач и объёмов. Выбор подходящего автозаправщика зависит от интенсивности работы и условий эксплуатации. Использование проверенных систем заправки гарантирует безопасность и бесперебойную работу на всех объектах.</p>
        
        <h2 class="text-[22px] mt-5 mb-3">Ассортимент</h2>
        <p class="mb-4">Компания «РусТрак» предлагает разнообразную технику, где каждая модель АТЗ адаптирована под различные задачи и объёмы работы. В нашем каталоге представлены автомобили ведущих марок:</p>
        
        <ul class="list-none pl-0 mb-4 [&>li]:relative [&>li]:pl-[25px] [&>li]:mb-[10px] [&>li]:text-[18px] [&>li]:before:content-['♦'] [&>li]:before:absolute [&>li]:before:left-0 [&>li]:before:text-[#fec80b] [&>li]:before:text-[16px] [&>li]:before:top-[2px]">
            <li>ГАЗ</li>
            <li>КАМАЗ</li>
            <li>JAC</li>
            <li>FAW</li>
        ...
        <p class="mb-4">Доступные варианты вместимости цистерн:</p>
        ...
        <p class="mb-4">Все модели сертифицированы и соответствуют современным стандартам качества и безопасности, что гарантирует надёжность, долговечность и уверенность в бесперебойной работе.</p>
        
        <h2 class="text-[22px] mt-5 mb-3">Особенности автотопливозаправщиков</h2>
        <ul class="list-none pl-0 mb-4 [&>li]:relative [&>li]:pl-[25px] [&>li]:mb-[10px] [&>li]:text-[18px] [&>li]:before:content-['♦'] [&>li]:before:absolute [&>li]:before:left-0 [&>li]:before:text-[#fec80b] [&>li]:before:text-[16px] [&>li]:before:top-[2px]">
